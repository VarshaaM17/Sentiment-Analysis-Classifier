...
- **Processing:** Scripted logic to extract and count specific engagement metrics.
- **Scoring Logic:** Created functions to calculate sentiment scores by matching tweet content against sentiment dictionaries.
- **Visualization:** Generated a scatter plot to identify engagement patterns.

## Skills Used
Python, CSV Data Parsing, File I/O, String Manipulation.
